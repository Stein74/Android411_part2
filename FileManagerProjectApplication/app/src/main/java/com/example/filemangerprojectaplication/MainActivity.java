...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (StorageVolume volume : storageList) {
            ...
            var item = menu.add(R.id.group_storages, storageList.indexOf(volume), menu.size(), description);
            item.setIcon(R.drawable.baseline_folder_24);
            item.setCheckable(true);

            menu.setGroupCheckable(R.id.group_storages, true, true);
        ...
        var more_submenu = menu.addSubMenu(Menu.NONE, Menu.NONE, menu.size(), "More");
        if (more_submenu != null) {
            var item_about = more_submenu.add(Menu.NONE, Menu.NONE, 0, "About");
            item_about.setIcon(R.drawable.baseline_info_24);
